...
class TsneHelpersTestSuite extends FlatSpec with Matchers with Inspectors {
  ...
  "jointProbabilities" should "return the symmetrized probability distribution p_ij over the" +
    "datapoints" in {
    val env = ExecutionEnvironment.getExecutionEnvironment
  ...
  "jointProbabilities" should "return the sparse symmetrized probability distribution p_ij" +
    "over thedatapoints" in {
    val env = ExecutionEnvironment.getExecutionEnvironment

    val pairwiseAffinities =
      env.fromCollection(TsneHelpersTestSuite.sparsePairwiseAffinitiesResults)
    val results = jointDistribution(pairwiseAffinities).collect()
  ...
  "Gradient" should "return the gradient" in {
    ...
    val svJntDistribution: DataSet[(Int, Vector[Double])] =
      jointDistribution.groupBy(0).reduceGroup {
      entries =>
  ...
  "initWorkingSet" should "randomly initialize the embedding and initialize gradient and gains to" +
    "zero" in {
    val env = ExecutionEnvironment.getExecutionEnvironment
  ...
  "updateEmbedding" should "return the updated embedding by the gradient with momentum and" +
    "gain" in {
    val env = ExecutionEnvironment.getExecutionEnvironment
  ...
  "iterationComputation" should "iteratively compute the embedding" in {
    ...
    val results = iterationComputation(iterations, momentum, workingSet, svJntDistribution, metric,
      learningRate, theta, 2, 0)
      .map(x => (x._1, x._2)).collect()
...
object TsneHelpersTestSuite {
  ...
  val densePairwiseAffinitiesResults: Seq[(Int, Int, Double)] = List(
    (0, 1, 2.370974987703e-02), (0, 2, 5.153826240184e-05), (0, 3, 1.945495759780e-02),
    (0, 4, 8.216433537309e-04), (0, 5, 4.872518553230e-03), (0, 6, 7.036533081247e-02),
    (0, 7, 8.338103510412e-01), (0, 8, 4.291578136374e-02), (0, 9, 3.998129138403e-03),
    (1, 0, 7.724806516559e-01), (1, 2, 1.365877675224e-09), (1, 3, 3.248251955497e-05),
    (1, 4, 5.336682282239e-04), (1, 5, 1.440504524837e-01), (1, 6, 1.402694896096e-05),
    (1, 7, 8.229819286616e-02), (1, 8, 5.685570334838e-05), (1, 9, 5.336682282239e-04),
    (2, 0, 1.898500331402e-03), (2, 1, 8.687658519724e-04), (2, 3, 5.062254851994e-02),
    (2, 4, 1.449209955883e-02), (2, 5, 3.548272991202e-03), (2, 6, 2.928791467503e-02),
    (2, 7, 3.166935688445e-02), (2, 8, 2.316520085169e-02), (2, 9, 8.444473403355e-01),
    (3, 0, 2.390453996554e-04), (3, 1, 1.395251795149e-08), (3, 2, 1.371014800172e-06),
    (3, 4, 2.369600685486e-03), (3, 5, 1.347198827355e-04), (3, 6, 3.128918783462e-02),
    (3, 7, 2.411490824021e-05), (3, 8, 7.330981240389e-01), (3, 9, 2.328438222830e-01),
    (4, 0, 1.019336232626e-04), (4, 1, 2.549661856719e-04), (4, 2, 8.105432254715e-05),
    (4, 3, 9.980288326134e-03), (4, 5, 5.017868132870e-03), (4, 6, 1.751495817431e-01),
    (4, 7, 1.008626268887e-03), (4, 8, 7.770114760492e-01), (4, 9, 3.139420534839e-02),
    (5, 0, 9.336380191993e-06), (5, 1, 1.005438326603e-03), (5, 2, 1.769727010776e-13),
    (5, 3, 2.563249124685e-03), (5, 4, 1.665948534565e-02), (5, 6, 1.977751128205e-10),
    (5, 7, 2.760372711471e-01), (5, 8, 1.333923297742e-08), (5, 9, 7.037252061386e-01),
    (6, 0, 2.657830365339e-02), (6, 1, 4.705122579295e-03), (6, 2, 7.129194416069e-03),
    (6, 3, 3.052697452006e-02), (6, 4, 5.312632631673e-02), (6, 5, 4.705122579295e-03),
    (6, 7, 8.775567604535e-03), (6, 8, 8.480859960929e-01), (6, 9, 1.636739223770e-02),
    (7, 0, 8.439216060511e-01), (7, 1, 2.173031429002e-02), (7, 2, 4.863220572021e-03),
    (7, 3, 1.840043131472e-02), (7, 4, 1.319325614475e-02), (7, 5, 6.961968258558e-02),
    (7, 6, 7.370873853279e-03), (7, 8, 2.500183873820e-03), (7, 9, 1.840043131472e-02),
    (8, 0, 1.718948684906e-02), (8, 1, 3.907353474692e-03), (8, 2, 4.531278151932e-03),
    (8, 3, 3.605396373725e-02), (8, 4, 7.022214844512e-02), (8, 5, 4.531278151932e-03),
    (8, 6, 8.397228403177e-01), (8, 7, 3.907353474692e-03), (8, 9, 1.993429739760e-02),
    (9, 0, 4.341453089465e-07), (9, 1, 2.423850003604e-08), (9, 2, 9.192527632300e-02),
    (9, 3, 8.003537295921e-01), (9, 4, 9.192527632300e-02), (9, 5, 5.132223630089e-03),
    (9, 6, 9.710748028923e-05), (9, 7, 7.776147410114e-06), (9, 8, 1.055815212027e-02)
  ).toSeq

  val denseJointProbabilitiesResults: Seq[(Int, Int, Double)] = List(
    (0, 1, 3.980952007665e-02), (0, 2, 9.750192969019e-05), (0, 3, 9.847001498727e-04),
    (0, 4, 4.617884884968e-05), (0, 5, 2.440927466711e-04), (0, 6, 4.847181723293e-03),
    (0, 7, 8.388659785461e-02), (0, 8, 3.005263410640e-03), (0, 9, 1.999281641856e-04),
    (1, 0, 3.980952007665e-02), (1, 2, 4.343836089250e-05), (1, 3, 1.624823603646e-06),
    (1, 4, 3.943172069479e-05), (1, 5, 7.252794540517e-03), (1, 6, 2.359574764128e-04),
    (1, 7, 5.201425357809e-03), (1, 8, 1.982104589020e-04), (1, 9, 2.668462333619e-05),
    (2, 0, 9.750192969019e-05), (2, 1, 4.343836089250e-05), (2, 3, 2.531195976737e-03),
    (2, 4, 7.286576940686e-04), (2, 5, 1.774136495689e-04), (2, 6, 1.820855454555e-03),
    (2, 7, 1.826628872824e-03), (2, 8, 1.384823950181e-03), (2, 9, 4.681863083292e-02),
    (3, 0, 9.847001498727e-04), (3, 1, 1.624823603646e-06), (3, 2, 2.531195976737e-03),
    (3, 4, 6.174944505810e-04), (3, 5, 1.348984503710e-04), (3, 6, 3.090808117734e-03),
    (3, 7, 9.212273111480e-04), (3, 8, 3.845760438881e-02), (3, 9, 5.165987759376e-02),
    (4, 0, 4.617884884968e-05), (4, 1, 3.943172069479e-05), (4, 2, 7.286576940686e-04),
    (4, 3, 6.174944505810e-04), (4, 5, 1.083867673926e-03), (4, 6, 1.141379540299e-02),
    (4, 7, 7.100941206818e-04), (4, 8, 4.236168122471e-02), (4, 9, 6.165974083570e-03),
    (5, 0, 2.440927466711e-04), (5, 1, 7.252794540517e-03), (5, 2, 1.774136495689e-04),
    (5, 3, 1.348984503710e-04), (5, 4, 1.083867673926e-03), (5, 6, 2.352561388535e-04),
    (5, 7, 1.728284768663e-02), (5, 8, 2.265645745583e-04), (5, 9, 3.544287148844e-02),
    (6, 0, 4.847181723293e-03), (6, 1, 2.359574764128e-04), (6, 2, 1.820855454555e-03),
    (6, 3, 3.090808117734e-03), (6, 4, 1.141379540299e-02), (6, 5, 2.352561388535e-04),
    (6, 7, 8.073220728907e-04), (6, 8, 8.439044182053e-02), (6, 9, 8.232249858994e-04),
    (7, 0, 8.388659785461e-02), (7, 1, 5.201425357809e-03), (7, 2, 1.826628872824e-03),
    (7, 3, 9.212273111480e-04), (7, 4, 7.100941206818e-04), (7, 5, 1.728284768663e-02),
    (7, 6, 8.073220728907e-04), (7, 8, 3.203768674256e-04), (7, 9, 9.204103731065e-04),
    (8, 0, 3.005263410640e-03), (8, 1, 1.982104589020e-04), (8, 2, 1.384823950181e-03),
    (8, 3, 3.845760438881e-02), (8, 4, 4.236168122471e-02), (8, 5, 2.265645745583e-04),
    (8, 6, 8.439044182053e-02), (8, 7, 3.203768674256e-04), (8, 9, 1.524622475894e-03),
    (9, 0, 1.999281641856e-04), (9, 1, 2.668462333619e-05), (9, 2, 4.681863083292e-02),
    (9, 3, 5.165987759376e-02), (9, 4, 6.165974083570e-03), (9, 5, 3.544287148844e-02),
    (9, 6, 8.232249858994e-04), (9, 7, 9.204103731065e-04), (9, 8, 1.524622475894e-03)
  ).toSeq

  val denseSumQ = 3.365625463923e+01

  val denseUnnormLowDimAffinitiesResults: Seq[(Int, Int, Double)] = List(
    (0, 1, 1.997990966178e-01), (0, 2, 3.438741251510e-01), (0, 3, 5.084645547121e-01),
    (0, 4, 2.228754579760e-01), (0, 5, 2.111669473429e-01), (0, 6, 4.799407190805e-01),
    (0, 7, 3.639911864625e-01), (0, 8, 6.947858598830e-01), (0, 9, 2.137434062812e-01),
    (1, 0, 1.997990966178e-01), (1, 2, 8.232738803226e-02), (1, 3, 1.487280153275e-01),
